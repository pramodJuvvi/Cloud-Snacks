...
export function HomeScreen() {
  ...
  const preferenceFilters = ["All", "6 delivery days", "24 delivery days", "High protein", "Low spice", "Millet-based", "No refined sugar"];
  const combos = [
    { name: "Family Trial Pack", items: ["Kids Telangana Starter Box", "Teen Energy Builder Box"], accent: "#b45309" },
    { name: "Office Wellness Pack", items: ["Adult Workday Balance Box", "Adult Millet Lunch Box"], accent: "#0f766e" },
    { name: "Senior Care Pack", items: ["Senior Light Comfort Box", "Senior Millet Digest Box"], accent: "#be123c" },
  ];
      ...
      >
        ...
        >
          <View style={styles.heroTopRow}>
            <Text style={styles.kicker}>Cloud Snack Box</Text>
            <View style={styles.liveBadge}>
              <Ionicons name="sparkles-outline" size={14} color={theme.colors.charcoal} />
              <Text style={styles.liveBadgeText}>Dietician curated</Text>
            </View>
          </View>
          <Text style={styles.title}>Age-wise snack boxes for steady daily nutrition.</Text>
          <Text style={styles.heroCopy}>
            Hyderabad-style subscription boxes for kids, teens, adults, and seniors with millet, protein sides, fruit, and traditional drinks.
          </Text>
          <View style={styles.heroStats}>
            ...
            <View style={styles.statTile}>
              ...
              <Text style={styles.statLabel}>regional foods</Text>
            </View>
          </View>
        </LinearGradient>
        ...
        <View style={styles.sectionHeader}>
          ...
          <Text style={styles.sectionSubtext}>
            {visibleSnacks.length} curated boxes across kids, teens, adults, and seniors.
          </Text>
        </View>
        ...
        <TextInput
          ...
          placeholder="Search boxes, age group, millet, protein"
        ...
        <View style={styles.comboSection}>
          <Text style={styles.comboTitle}>Quick subscriptions</Text>
          ...
          <View style={styles.modalPanel}>
            {selectedSnack ? (
              <>
                ...
                <Text style={styles.detailLabel}>Nutrition Plan</Text>
