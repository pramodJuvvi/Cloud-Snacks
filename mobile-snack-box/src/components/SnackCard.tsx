    ...
    >
      ...
      <View style={styles.body}>
        ...
        <View style={styles.metaRow}>
          ...
          <Text style={styles.pillText}>{snack.prepMinutes} day setup</Text>
          </View>
          <View style={styles.pill}>
        ...
        <Pressable
          accessibilityRole="button"
          accessibilityLabel={`Subscribe to ${snack.name}`}
        ...
        >
          ...
          <Text style={styles.addButtonText}>{isAvailable ? "Subscribe" : "Unavailable"}</Text>
        </Pressable>
      </View>
    </Pressable>
  );
